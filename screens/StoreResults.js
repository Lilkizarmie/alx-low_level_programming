      ...
      <View style={styles.frameView19}>
          ...
          <View style={styles.frameView}>
            <View style={styles.groupView}>
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/group-68504.png")}
              />
            ...
            <View style={styles.groupView3}>
              <View style={styles.groupView2}>
                ...
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../assets/sony-electronics--png-01.png")}
                />
              </View>
          ...
          <View style={styles.frameView2}>
            <View style={styles.groupView6}>
              <View style={styles.groupView5}>
                ...
                <Image
                  style={styles.lGElectronicsPng0}
                  resizeMode="cover"
                  source={require("../assets/lg-electronics--png-0.png")}
                />
              </View>
            </View>
          ...
          <View style={styles.frameView3}>
            <View style={styles.groupView7}>
              ...
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/esteelauder3-11.png")}
              />
            </View>
          ...
          <View style={styles.frameView4}>
            <View style={styles.groupView8}>
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/group-68505.png")}
              />
          ...
          <View style={styles.frameView5}>
            <View style={styles.groupView9}>
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/group-68506.png")}
              />
          ...
          <View style={styles.groupView12}>
            ...
            <View style={styles.frameView7}>
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/beats-electronics--png-01.png")}
              />
            </View>
          </View>
        ...
        <View style={styles.frameView9}>
          <View style={styles.groupView13}>
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/versace--png-01.png")}
            />
          </View>
        ...
        <View style={styles.frameView10}>
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/clarins-11.png")}
          />
        ...
        <View style={styles.frameView11}>
          <View style={styles.groupView15}>
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/group-68511.png")}
            />
        ...
        <View style={styles.frameView13}>
          <View style={styles.groupView18}>
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/samsung-electronics--png-02.png")}
            />
          </View>
        ...
        <View style={styles.frameView14}>
          <View style={styles.groupView19}>
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/ikea--png-01.png")}
            />
          </View>
        ...
        <View style={styles.frameView16}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/group-68532.png")}
          />
        ...
        <View style={styles.frameView17}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/group-68533.png")}
          />
