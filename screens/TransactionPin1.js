  ...
  return (
    <View style={styles.transactionPinView}>
      <View style={styles.barsTopBarsV1View}>
        ...
        />
        <Text style={styles.titleText}>Change Transaction Pin</Text>
      </View>
      ...
      <View style={styles.passwordView1}>
        ...
        <Text style={styles.labelText1}>Confirm New Pin</Text>
      </View>
      <View style={styles.passwordView2}>
        ...
        <Text style={styles.labelText2}>Current pin</Text>
      </View>
    </View>
  );
};
...
export default TransactionPin1;
