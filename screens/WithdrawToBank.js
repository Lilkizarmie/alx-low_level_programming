...
const WithdrawToBank = () => {
  return (
    <View style={styles.withdrawToBank1}>
      ...
      <View style={styles.iPhone11ProX3}>
        <Text style={styles.withdrawToBank}>Withdraw to Bank</Text>
        ...
        <View style={styles.buttonView1}>
          ...
          <Image
            ...
            source={require("../assets/iconsarrowsarrowlongright.png")}
          />
          <Text style={styles.text4}>Withdraw Money</Text>
        </View>
        <View style={styles.itemView2}>
          ...
          />
          <Text style={styles.labelText}>Choose preferred Bank</Text>
        </View>
        <View style={styles.itemView3}>
          ...
          <Text style={styles.labelText1}>Enter Account Number</Text>
        </View>
        <View style={styles.itemView4}>
          ...
          <Text style={styles.labelText2}>Account Name</Text>
        </View>
        <View style={styles.itemView5}>
          ...
          <Text style={styles.labelText3}>Amount to Withdraw</Text>
        </View>
        <Image
